 ...
 */
 ...
 const char* MY_ANCHOR_LABEL = "B";     // Etiqueta legible ("A", "B", "C", "D")
 const uint16_t MY_ANCHOR_UWB_ID = 20;    // ID numérico UWB (10, 20, 30, 40) - Debe coincidir con ANCHOR_IDS en el Tag
 const float   MY_ANCHOR_X = 0.0;         // Coordenada X medida exacta (en metros)
 const float   MY_ANCHOR_Y = 4.55;         // Coordenada Y medida exacta (en metros)
