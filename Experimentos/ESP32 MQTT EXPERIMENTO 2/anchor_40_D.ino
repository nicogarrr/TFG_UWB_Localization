 ...
 */
 ...
 const char* MY_ANCHOR_LABEL = "D";     // Etiqueta legible ("A", "B", "C", "D")
 const uint16_t MY_ANCHOR_UWB_ID = 40;    // ID numérico UWB (10, 20, 30, 40) - Debe coincidir con ANCHOR_IDS en el Tag
 const float   MY_ANCHOR_X = 3.45;         // Coordenada X medida exacta (en metros)
 const float   MY_ANCHOR_Y = 0.66;         // Coordenada Y medida exacta (en metros)
